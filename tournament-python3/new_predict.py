...
def download_data():
    ...
    return features, training_data, validation_data, live_data

def train(training_data):
    """ This method needs to train a model and allocate it """

    # Must read the training data of course !!!

    # Then most create a model, and early return it if exists.
...
def predict(model, features, training_data, validation_data, live_data):
